...
import 'package:ichack_backend_server/src/generated/endpoints.dart';
...
class TestEndpoints {
  ...
  late final _ProcessVid processVid;

  late final _TextEndpoint text;
}
...
class _ProcessVid {
  ...
  _i3.Future<String> processVideo(
    _i1.TestSessionBuilder sessionBuilder,
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'processVid',
          methodName: 'processVideo',
          parameters: _i1.testObjectToJson({'faceResults': faceResults}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue = await (_localCallContext.method.call(
          _localUniqueSession,
...
class _TextEndpoint {
  ...
  _i3.Future<String> generateReply(
    _i1.TestSessionBuilder sessionBuilder, {
